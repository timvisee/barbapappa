...
return [
    ...
    'bunqmetab' => [
        'waitOnReceipt' => 'Aan het wachten tot de betaling ontvangen is. Dit kan tot een aantal dagen duren.',
        'waitOnCreate' => 'De betaling wordt gestart in de achtergrond. Even geduld alsjeblieft.',
        'pleasePay' => 'Klik op de \'Betaal\' knop en voltooi de betaling via bunq.',
        'handledByBunq' => 'Je betaling zal behandeld worden door bunq, een bank die hiervoor een service verleent. Je kunt met iDeal/Wero betalen op de bunq-betaalpagina.',
