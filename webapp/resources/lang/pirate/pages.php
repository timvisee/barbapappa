...
return [
    ...
    'transactions' => [
        ...
        'descriptions' => [
            'depositProductWithdrawWallet' => 'Payment for product(s) wit\' wallet',
            'depositProduct' => 'Payment for product(s)',
            'depositWalletWithdrawPayment' => 'Deposit to wallet from external account',
            'depositWalletWithdrawWallet' => 'Transfer between wallets',
            'depositWallet' => 'Deposit to wallet',
            'withdrawWallet' => 'Withdrawal from wallet',
        ],
    ],
    ...
    'mutations' => [
        ...
        'types' => [
            ...
            'walletWithdraw' => 'Payed wit\' wallet',
            'walletDepositDetail' => 'Deposit to :wallet',
            'walletWithdrawDetail' => 'Payed wit\' :wallet',
            'productDeposit' => 'Received booty for product(s)',
            'productWithdraw' => 'Payed for product(s)',
            'paymentDeposit' => 'Withdrawal to external account',
