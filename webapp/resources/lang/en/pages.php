...
return [
    ...
    'inventories' => [
        ...
        'stats' => [
            ...
            'changeAbsSum' => 'Change volume',
            'balanceCount' => '# of rebalance changes',
            'balanceSum' => 'Rebalance sum',
            'balanceAbsSum' => 'Rebalance volume',
            'balanceMoneySum' => 'Rebalance money sum',
            'addSum' => 'Added product volume',
            'removeSum' => 'Removed product volume',
            'moveInSum' => 'Moved-in volume',
            'moveOutSum' => 'Moved-out volume',
            'purchaseCount' => '# of purchase changes',
            'purchaseSum' => 'Purchase volume',
        ],
