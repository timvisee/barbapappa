...
return [
    ...
    'invalidateAllSessionsDescription' => 'Keep the switch below toggled on to log out on all devices.<br />'
    ...
    'invalidateOtherSessionsDescription' => 'Keep the switch below toggled on to log out on all other devices.<br />'
        . 'This option should be checked if you believe your account may have been used by someone else.',
];
