...
@if($r == 'about' || rand_float() <= (float) config('app.pirate_chance'))
    <a href="{{ route('language', [
                'locale' => 'pirate',
                'redirect' => url()->full(),
            ]) }}"
