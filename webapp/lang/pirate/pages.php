...
return [
    ...
    'finance' => [
        ...
        'members' => [
            ...
            'howToSettle' => 'To settle these, users should register an account and verify their e-bottle coordinate. Or settle these manually and zero the wallet balance.',
        ],
        'aliasWallets' => [
            ...
            'settled' => 'Settled?',
            'howToSettle' => 'To settle these, users should register an account and verify their e-bottle coordinate. A green tick will be shown below when all orphan wallets have been assigned.',
        ],
        'imports' => [
    ...
    'bar' => [
        ...
        'purchaseSummaryDescription' => 'Dis page shows a summary of recent purchased loot by pirates in dis bar.',
    ...
    'errors' => [
        ...
        '429' => [
            ...
            'description' => 'Whoops! Too many requests be made to dis page recently on dis network. For security reasons we temporarily block fresh requests. Switch to a different network such as a cellular connection or wait some time to try again.',
        ],
        '500' => [
