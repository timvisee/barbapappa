...
return [
    ...
    'economies' => [
        ...
        'deleteAllWalletsConfirmText' => 'verwijder portemonnees van alle gebruikers',
    ...
    'products' => [
        ...
        'inventoryProducts' => 'Alternatieve inventarisproducten',
    ...
    'inventories' => [
        ...
        'barInventory' => 'Bar inventaris',
        'allInventories' => 'Alle inventarissen',
        ...
        'addRemove' => '+ / -',
        'addRemoveProducts' => 'Producten toevoegen/verwijderen',
        'addRemoveDescription' => 'Voeg producten toe of verwijder ze, bijvoorbeeld na het doen van nieuwe inkopen. Laat velden leeg om balansen over te slaan.',
        'defaultAddRemoveComment' => 'Toevoegen/verwijderen van producten',
        'rebalance' => 'Balansen',
        ...
        'defaultRebalanceComment' => 'Periodieke herbalans',
        'move' => 'Verplaatsen',
        ...
        'drainEstimateOthers' => 'Voorraad alle inventarissen',
        'stats' => [
            'period' => 'Periode',
            'changeCount' => '# aanpassingen',
            'manualChangeCount' => '# handmatige aanpassingen',
            'balanceCount' => '# balans aanpassingen',
            'purchaseCount' => '# aankoop aanpassingen',
            'quantityVolume' => 'Totale hoeveelheid volume',
            'quantitySum' => 'Totale hoeveelheid som',
            'unbalanceVolume' => 'Ongebalanceerde volume',
            'unbalanceSum' => 'Ongebalanceerde som',
            'unbalanceMoney' => 'Ongebalanceerd bedrag',
            'purchaseVolume' => 'Aankoop volume',
            'addSum' => 'Producten toegevoegd',
            'removeSum' => 'Producten verwijderd',
            'moveInSum' => 'Producten in-verplaatst',
            'moveOutSum' => 'Producten uit-verplaatst',
        ],
        'unbalancedProducts' => 'Ongebalanceerde producten',
    ...
    'balanceImport' => [
        ...
        'deleteQuestion' => 'Je staat op het punt dit saldoimportsysteem te verwijderen. Saldoimports die al op portemonnees zijn toegepast zullen niet teruggedraaid worden. Hiermee verwijder je ook alle gerelateerde geïmporteerde data. Weet je zeker dat je door wilt gaan?',
    ...
    'balanceImportChange' => [
        ...
        'migrateDescription' => 'Migreer deze balansimportalias om gegevens van de gebruiker aan te passen. Wanneer het e-mailadres wordt aangepast naar dat van een bestaande gebruiker zullen de aanpassingen voor de alias toegepast worden op zijn portemonnee. Balansimportaanpassingen die al zijn toegepast worden niet overgedragen naar een andere gebruiker.',
        'migrated' => 'De balansimport alias is gemigreerd.',
    ...
    'balanceImportAlias' => [
        ...
        'aliasWithEmailAlreadyExists' => 'Een alias met dit e-mailadres bestaat al.',
    ...
    'finance' => [
        ...
        'memberAndNonMemberCumulative' => 'Lid + niet-lid cumulatief',
        'nonMemberCumulative' => 'Niet-lid cumulatief',
    ...
    'bar' => [
        ...
        'tallySummaryDescription' => 'De turfjes tonen het aantal gekochte producten bij gebruikers in de bar.',
        'tallySummaryLimited' => 'Niet alle turfjes worden getoond, het zijn er teveel.',
        'tallySummaryDescriptionSum' => ':quantity turfjes van :from tot :to',
    ...
    'kiosk' => [
        ...
        'buyProducts#' => '{0} Koop geen producten|{1} Koop product|[2,*] Koop :count producten',
        'buyProductsUsers#' => '{0} Koop geen producten|[1,*] Koop :count× / :users leden',
    ...
    'errors' => [
        ...
        '429' => [
            ...
            'description' => 'Oeps! Er zijn recent teveel verzoeken voor deze pagina gestuurd via dit netwerk. Om veiligheidsredenen blokkeren we daarom tijdelijk nieuwe verzoeken. Verbind met een ander netwerk zoals een mobiele verbinding of wacht even om het opnieuw te proberen.',
        ],
        '500' => [
